...
export default function Messages() {
  ...
  if (loading) {
    return <LoadingSkeleton type="messages" />;
  }
  ...
  return (
    <div className="flex w-full gap-3 p-5 h-screen">
      ...
      >
        <Button
          className="md:hidden bg-white text-primary font-semibold mb-2 border border-primary w-20 text-center rounded-sm hover:bg-primary hover:text-white transition-colors"
      ...
      {property && (
        <div
          className={`hidden md:flex flex-col ${sidebarOpen ? "w-1/3" : "w-10 h-16 border-0 shadow-none"} border p-3 rounded-lg shadow-md`}
        >
          {sidebarOpen ? (
            <>
              <X
              ...
              <div className="flex justify-between">
                <div className="flex space-x-2 mb-2">
                  <button className="border border-primary text-primary px-2 py-1 rounded-lg text-sm flex items-center">
                ...
                <button className="border border-primary text-primary px-2 py-1 mb-2 rounded-lg text-sm">
              ...
              <div className="flex justify-between">
                ...
                <p className="text-xl font-bold text-destructive ml-2">
                  {priceText}
                </p>
              </div>
            </>
