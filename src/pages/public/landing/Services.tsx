...
export function Services() {
  ...
  return (
    <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm border">
              ...
              <p className=" mb-6 leading-relaxed">
                Discover your perfect property from thousands of verified
                listings across Addis Ababa.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border">
              ...
              <p className=" mb-6 leading-relaxed">
                ...
                Create detailed listings with photos and manage inquiries all in
                one place.
              </p>
              <ul className="space-y-3 ">
                {[
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border">
              ...
              <p className=" mb-6 leading-relaxed">
                We prioritize the safety and security of all transactions with
                verification and secure communication tools.
              </p>
              <ul className="space-y-3 ">
                {[
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Platform Tools</h2>
            <p className="text-lg ">
              Everything you need for successful transactions
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Communicate securely with buyers or sellers through our built-in messaging system.",
              },
              {
                icon: ShieldCheckIcon,
                title: "Verified Listings",
                desc: "All property listings are reviewed and verified by our team to ensure accuracy.",
              },
              {
                icon: BellIcon,
                title: "Smart Notifications",
                desc: "Get instant alerts for new listings, messages, and important updates.",
              },
            ].map((tool, i) => (
              <div
                key={i}
              ...
              >
                <div className="w-16 h-16 bg-secondary rounded-lg flex items-center justify-center mb-6 mx-auto">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg ">
              From listing to closing in four easy steps
            </p>
          </div>
            ...
            {[
              ...
              <div key={i} className="text-center">
                ...
                <p className=" text-sm">
                  ...
                  {i === 1 &&
                    "Sellers create listings; buyers search and filter properties."}
                  {i === 2 &&
                    "Message directly to discuss details and arrange viewings."}
                  {i === 3 &&
                    "Finalize the transaction directly—no middleman needed."}
                </p>
              </div>
            ))}
          </div>
      ...
      <section
        className={`py-20 bg-gradient-to-r from-primary to-teal-700 text-white ${isLoggedIn ? "hidden" : ""}`}
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-10 opacity-90">
            Whether you're buying or selling, create your account today and
            start connecting.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Button
              asChild
              size="lg"
              className="bg-white text-primary hover:bg-gray-100 font-semibold text-lg px-10 py-6"
            >
