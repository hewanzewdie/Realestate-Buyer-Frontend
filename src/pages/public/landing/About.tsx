...
export default function About() {
  return (
    <div className="">
      ...
      <p className="text-2xl  w-2/3 mb-10 mt-5 px-10">
        We're building Ethiopia's most trusted real estate marketplace,
        connecting property buyers and sellers directly for transparent,
      ...
      <div className="flex md:flex-row flex-col items-center justify-between bg-gray-50 p-10">
        <div className="flex flex-col space-y-6">
          ...
          <p className="text-lg ">
            Founded in Addis Ababa, our platform was created to solve a simple
            problem: real estate transactions in Ethiopia needed to be more
            direct, transparent, and accessible.
          </p>
          <p className="text-lg ">
            We built a marketplace where property owners can list their homes
            directly and buyers can discover opportunities without unnecessary
            intermediaries. No commissions, no hidden fees—just a platform that
            connects people.
          </p>
          <p className="text-lg  mb-5">
            Today, thousands of buyers and sellers use our platform every month
            to list properties, discover homes, and complete transactions with
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg ">The principles that guide our platform</p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg ">Simple steps for buyers and sellers</p>
          </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">Browse & Search</h4>
                    <p className=" text-sm">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">Connect with Sellers</h4>
                    <p className=" text-sm">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">Receive Inquiries</h4>
                    <p className=" text-sm">
      ...
      <section className="flex flex-col space-y-3 items-center justify-center pb-10">
        ...
        <p className="text-lg ">Answers to common questions</p>
        <Accordion
          type="single"
          collapsible
          className="w-3/4"
        ...
        >
          <AccordionItem value="item-1">
            ...
            <AccordionContent className="flex flex-col gap-4 text-balance">
              <p className="text-lg ">
                Click "Sign Up" in the top right corner and choose whether you
                want to register as a buyer or seller. Complete the verification
                process to start using the platform.
              </p>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent className="flex flex-col gap-4 text-balance">
              <p className="text-lg ">
                After creating a seller account, go to your Listing page and
                click "Add Listing." Add names, property details, pricing, and
                publish. Your listing will be added instantly.
              </p>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            <AccordionTrigger className="text-xl">
              How do I contact a seller about a property?
            </AccordionTrigger>
            <AccordionContent className="flex flex-col gap-4 text-balance">
              <p className="text-lg ">
                Once you're logged in as a buyer, you can message sellers
                directly through our secure messaging system on any property
                listing page.
              </p>
            </AccordionContent>
          </AccordionItem>
